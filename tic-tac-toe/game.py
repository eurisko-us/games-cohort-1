class Game:
    ...
    def __init__(self, strategies, logging=False):
        ...
        # A 0 is clear, a 1 is X or strategy 0, and a -1 is strategy 1.
    ...
    def check_tie(self):
        return 0 not in [e for row in self.board for e in row]
    ...
    def play_game(self):
        ...
        while True:
            ...
            xpos_to_move, ypos_to_move = self.strategies[strat].move(self.board)
